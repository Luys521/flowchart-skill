...
| 模块级 | 07 | _unlink_quiet | 任务 | — | — | — | 脚本 | selfboot | — | →10 | ★ 删文件；不存在或删不掉都静默忽略。 · L96 · 函数 |
| 模块级 | 08 | _capture_screenshot | 任务 | — | — | — | 脚本 | selfboot | — | →07 | ★ 起无头浏览器对裁剪页截图并轮询等文件落盘；成功返回 True。 · L104 · 函数 |
| 模块级 | 09 | main | 任务 | — | — | — | 脚本 | selfboot | — | 1→02｜2→03｜3→04｜4→05｜5→06｜6→07｜7→08 | L124 · 函数 · 分支：1→find_browser 2→build_crop_page 3→_parse_args 4→_output_path 5→_parse_crop 6→_unlink_quiet 7→_capture_screenshot |
