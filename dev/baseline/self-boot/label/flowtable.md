...
| Labeler | 09 | Labeler._pitch | 任务 | — | — | — | 脚本 | selfboot | — | →18 | ★ 竖线左右能给标签让出的横向预算 = **本图实际的通道档距**。 · L62 · 方法 · ⇢ 依赖 geometry.snap |
...
| Labeler | 13 | Labeler._hits | 任务 | — | — | — | 脚本 | selfboot | — | →18 | L113 · 方法 |
| Labeler | 14 | Labeler._candidate_ts | 任务 | — | — | — | 脚本 | selfboot | — | →18 | ★ 候选弧长比例：中点优先，之后向两侧交替扩散。 · L120 · 方法 |
...
| Labeler | 17 | Labeler.label_rows | 任务 | — | — | — | 脚本 | selfboot | — | →15 | ★ 这条边的徽章分几行、每行是什么（渲染器照它画）。没算过就先算一次盒。 · L154 · 方法 |
