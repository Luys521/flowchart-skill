...
| 模块级 | 08 | parse_materials | 任务 | — | — | — | 脚本 | selfboot | — | →07 | ★ 材料层 → `(elements, 补注, 摘要, 跳过清单, 报错文案)`。非 PDF / 非 T2 一律跳过并记账。 · L141 · 函数 |
| 模块级 | 09 | main | 任务 | — | — | — | 脚本 | selfboot | — | 1→02｜2→03｜3→04｜4→08 | L199 · 函数 · 分支：1→_read_json 2→_write_notes 3→_page_span 4→parse_materials |
