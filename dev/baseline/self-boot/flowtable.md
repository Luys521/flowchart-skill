...
| 接管与解析 | 18 | 模块 · parse_pdf | 任务 | — | — | — | 脚本 | selfboot | — | →19 | 5 个函数 · ⊞ parse_pdf/flowtable.md |
| 接管与解析 | 19 | 模块 · probe | 任务 | — | — | — | 脚本 | selfboot | — | →20 | 9 个函数 · ⊞ probe/flowtable.md |
| 接管与解析 | 20 | 模块 · recon | 任务 | — | — | — | 脚本 | selfboot | — | →21 | 9 个函数 · ⊞ recon/flowtable.md |
| 渲染 | 21 | 模块 · render_drawio | 任务 | — | — | — | 脚本 | selfboot | — | →22 | 24 个函数 · ⊞ render_drawio/flowtable.md |
| 渲染 | 22 | 模块 · render_html | 任务 | — | — | — | 脚本 | selfboot | — | →23 | 23 个函数 · ⊞ render_html/flowtable.md |
| 渲染 | 23 | 模块 · render_svg | 任务 | — | — | — | 脚本 | selfboot | — | →24 | 11 个函数 · ⊞ render_svg/flowtable.md |
| 渲染 | 24 | 模块 · router | 任务 | — | — | — | 脚本 | selfboot | — | →25 | 30 个函数 · ⊞ router/flowtable.md |
| 接管与解析 | 25 | 模块 · semantics | 任务 | — | — | — | 脚本 | selfboot | — | →26 | 17 个函数 · ⊞ semantics/flowtable.md |
| 编排入口 | 26 | 模块 · shot | 任务 | — | — | — | 脚本 | selfboot | — | →27 | 8 个函数 · ⊞ shot/flowtable.md |
| 渲染 | 27 | 模块 · swimlane | 任务 | — | — | — | 脚本 | selfboot | — | →28 | 19 个函数 · ⊞ swimlane/flowtable.md |
| 同步闭环 | 28 | 模块 · sync | 任务 | — | — | — | 脚本 | selfboot | — | →29 | 10 个函数 · ⊞ sync/flowtable.md |
| DSL 装配 | 29 | 模块 · table_to_dsl | 任务 | — | — | — | 脚本 | selfboot | — | →30 | 14 个函数 · ⊞ table_to_dsl/flowtable.md |
| 产物审核 | 30 | 模块 · validate | 任务 | — | — | — | 脚本 | selfboot | — | →31 | 39 个函数 · ⊞ validate/flowtable.md |
| 同步闭环 | 31 | 模块 · writeback | 任务 | — | — | — | 脚本 | selfboot | — | →32 | 21 个函数 · ⊞ writeback/flowtable.md |
| 同步闭环 | 32 | 模块 · xml_reader | 任务 | — | — | — | 脚本 | selfboot | — | →33 | 40 个函数 · ⊞ xml_reader/flowtable.md |
