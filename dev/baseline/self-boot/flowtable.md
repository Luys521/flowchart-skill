...
| 编排入口 | 04 | 模块 · build_all | 任务 | — | — | — | 脚本 | selfboot | — | →05 | 4 个函数 · ⊞ build_all/flowtable.md |
| 接管与解析 | 05 | 模块 · capability | 任务 | — | — | — | 脚本 | selfboot | — | →06 | 12 个函数 · ⊞ capability/flowtable.md |
| 接管与解析 | 06 | 模块 · cells | 任务 | — | — | — | 脚本 | selfboot | — | →07 | 11 个函数 · ⊞ cells/flowtable.md |
| 编排入口 | 07 | 模块 · clarify | 任务 | — | — | — | 脚本 | selfboot | — | →08 | 14 个函数 · ⊞ clarify/flowtable.md |
...
| 渲染 | 20 | 模块 · lane_router | 任务 | — | — | — | 脚本 | selfboot | — | →21 | 35 个函数 · ⊞ lane_router/flowtable.md |
| 层级索引 | 21 | 模块 · layer_index | 任务 | — | — | — | 脚本 | selfboot | — | →22 | 9 个函数 · ⊞ layer_index/flowtable.md |
| 接管与解析 | 22 | 模块 · ledger | 任务 | — | — | — | 脚本 | selfboot | — | →23 | 9 个函数 · ⊞ ledger/flowtable.md |
| 产物审核 | 23 | 模块 · manifest | 任务 | — | — | — | 脚本 | selfboot | — | →24 | 29 个函数 · ⊞ manifest/flowtable.md |
| 接管与解析 | 24 | 模块 · parse | 任务 | — | — | — | 脚本 | selfboot | — | →25 | 15 个函数 · ⊞ parse/flowtable.md |
| 接管与解析 | 25 | 模块 · parse_legacy | 任务 | — | — | — | 脚本 | selfboot | — | →26 | 26 个函数 · ⊞ parse_legacy/flowtable.md |
| 接管与解析 | 26 | 模块 · parse_ooxml | 任务 | — | — | — | 脚本 | selfboot | — | →27 | 10 个函数 · ⊞ parse_ooxml/flowtable.md |
| 接管与解析 | 27 | 模块 · parse_pdf | 任务 | — | — | — | 脚本 | selfboot | — | →28 | 8 个函数 · ⊞ parse_pdf/flowtable.md |
...
| 渲染 | 35 | 模块 · render_html | 任务 | — | — | — | 脚本 | selfboot | — | →36 | 23 个函数 · ⊞ render_html/flowtable.md |
| 接管与解析 | 36 | 模块 · render_pages | 任务 | — | — | — | 脚本 | selfboot | — | →37 | 12 个函数 · ⊞ render_pages/flowtable.md |
| 渲染 | 37 | 模块 · render_svg | 任务 | — | — | — | 脚本 | selfboot | — | →38 | 11 个函数 · ⊞ render_svg/flowtable.md |
| 渲染 | 38 | 模块 · router | 任务 | — | — | — | 脚本 | selfboot | — | →39 | 30 个函数 · ⊞ router/flowtable.md |
| 接管与解析 | 39 | 模块 · semantics | 任务 | — | — | — | 脚本 | selfboot | — | →40 | 18 个函数 · ⊞ semantics/flowtable.md |
| 编排入口 | 40 | 模块 · shot | 任务 | — | — | — | 脚本 | selfboot | — | →41 | 8 个函数 · ⊞ shot/flowtable.md |
| 渲染 | 41 | 模块 · swimlane | 任务 | — | — | — | 脚本 | selfboot | — | →42 | 20 个函数 · ⊞ swimlane/flowtable.md |
| 同步闭环 | 42 | 模块 · sync | 任务 | — | — | — | 脚本 | selfboot | — | →43 | 10 个函数 · ⊞ sync/flowtable.md |
| DSL 装配 | 43 | 模块 · table_to_dsl | 任务 | — | — | — | 脚本 | selfboot | — | →44 | 14 个函数 · ⊞ table_to_dsl/flowtable.md |
